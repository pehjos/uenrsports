...
import {updateCoach} from '../../actions/coaches'
...
dispatch(updateCoach(currentId, { ...postData, name: user?.result?.name }));
clear();
...
setPostData({...postData, video:ofFREvent.target.result})
    ...
    //submit DATA TO BACKEND WITH UPDATE DETAILS

    const handleSubmit1 = async (e) => {
        e.preventDefault();
dispatch(updateCoach(basket._id,{ ...postData }));
