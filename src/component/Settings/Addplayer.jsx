...
const [currentRoom3, setCurrentRoom3] = useState(1)
const changeRoom3 = (newRoom3) => {
  setCurrentRoom3(newRoom3)
  }
...
<input required type="text" placeholder="nationality"value={postData.nationality}
onChange={(e)=>setPostData({...postData, nationality:e.target.value})}/>
<select required  onChange={(event) => changeRoom3(event.target.value)}
value={currentRoom3}>
